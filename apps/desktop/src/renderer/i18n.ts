...
const en = {
  ...
  usageBee: "Workspace Bee cache",
  usageBeeSeed: "Shared Bee seed",
  ...
  base: "Starting point",
  baseLocale: "en",
  baseCurrent: "Current project commit",
  baseBranches: "Local branches",
  baseRemotes: "Remote branches (last synced)",
  baseTags: "Tags",
  baseLocalHint: "Uses locally available history. Remote branches show their last synced state.",
  baseHistory: "Choose a starting commit",
  baseUntitled: "Untitled commit",
  baseNewer: "Newer commits",
  baseOlder: "Older commits",
  basePreviousRefs: "Previous branches / tags",
  baseNextRefs: "More branches / tags",
  baseAdvanced: "Advanced: enter a branch, tag, or commit",
  baseReference: "Branch, tag, or commit ID",
  baseResolve: "Check starting point",
  baseLoading: "Loading starting points…",
  baseLoadFailed: "Could not load Git history. Retry or check the local repository.",
  baseInvalid: "This starting point could not be found. Check the branch, tag, or commit.",
  baseRetry: "Retry",
  baseSelected: "Start from",
  cancel: "Cancel",
  removeConfirm:
...
const ko: Record<MessageKey, string> = {
  ...
  usageBee: "워크스페이스 Bee 캐시",
  usageBeeSeed: "공유 Bee 원본",
  ...
  base: "시작 지점",
  baseLocale: "ko",
  baseCurrent: "원본 프로젝트의 현재 커밋",
  baseBranches: "로컬 브랜치",
  baseRemotes: "원격 브랜치 (마지막 동기화 기준)",
  baseTags: "태그",
  baseLocalHint:
    "이 컴퓨터에 저장된 이력을 사용합니다. 원격 브랜치는 마지막으로 동기화된 상태입니다.",
  baseHistory: "시작할 커밋 선택",
  baseUntitled: "제목 없는 커밋",
  baseNewer: "더 최근 기록",
  baseOlder: "이전 기록",
  basePreviousRefs: "이전 브랜치 / 태그",
  baseNextRefs: "다음 브랜치 / 태그",
  baseAdvanced: "고급 옵션: 브랜치·태그·커밋 직접 입력",
  baseReference: "브랜치, 태그 또는 커밋 ID",
  baseResolve: "시작 지점 확인",
  baseLoading: "시작 지점을 불러오는 중…",
  baseLoadFailed: "Git 이력을 불러오지 못했습니다. 다시 시도하거나 로컬 저장소를 확인하세요.",
  baseInvalid: "시작 지점을 찾지 못했습니다. 브랜치·태그·커밋을 확인하세요.",
  baseRetry: "다시 시도",
  baseSelected: "선택한 시작 지점",
  cancel: "취소",
