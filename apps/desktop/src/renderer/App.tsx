      ...
      <main>
        <header className="topbar">
          <div>
            ...
            <h1>{selectedProfile?.label ?? "Choose a Unity project"}</h1>
          </div>
          {selectedProfile !== undefined && (
            <button
              className="secondary"
                      ...
                      <div className="work-card-head">
                        ...
                        {works.length > 1 && (
                          <button
                            ...
                            onClick={() =>
                              setWorks((current) => current.filter((item) => item.key !== work.key))
                            }
                          >
                            Remove
                          </button>
        ...
        {startedRunId !== undefined && (
          <div className="toast success-toast">
            ...
            <span>{startedRunId}</span>
            <button onClick={() => setStartedRunId(undefined)}>×</button>
          </div>
        )}
      </main>
    </div>
